        ...
        const fetchData = async () => {
            try {
                ...
                const processedCartItems = cartData.cart.map((item) => ({
                    ...
                    images: item.productId.images.map((img) => `http://localhost:5000${img}`),
                    ...
                    <div className='mb-6'>
                        ...
                        {paymentMethod === 'paypal' && (
                            <div className='mt-4' style={{ maxWidth: '500px' }}>
                                <PayPalScriptProvider options={{ 'client-id': "AbTl5gcW_n-2CrorjnlahqkeEd1pQm6B9DTepUtGVin7XcG0O9t6na298Fw8ooeefg6_0M2wK4Vvx1Pi" }}>
                                    <PayPalButtons
